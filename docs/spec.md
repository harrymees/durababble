...
- Object sleep replacement/cancellation is committed with object message completion and state persistence; dispatch inserts the wake mailbox message before removing the sleep row in the same transaction.
