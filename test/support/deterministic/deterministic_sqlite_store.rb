...
module Durababble
  module Deterministic
    ...
    class DeterministicSqliteStore < SqliteStore
      ...
      def record_step_failed_and_schedule_retry(workflow_id:, error:, worker_id:, run_at:, command_id: nil, position: nil, event_index:)
        out = super
      ...
      def record_step_canceled(workflow_id:, error:, command_id: nil, position: nil, worker_id: nil, event_index:)
        out = super
      ...
      def record_wait(workflow_id:, name:, wait_request:, command_id: nil, position: nil, suspend_workflow: true, worker_id: nil, next_run_at: nil, event_index:)
        wait_id = super
