  ...
  test "keeps hot-path store operations on explicit indexes in production-sized tables" do
    ...
    operations = {
      ...
      "release_worker_leases" => {
        ...
        allowed_indexes: ["workflows_worker_lease_idx", "outbox_worker_lease_idx", "inbox_worker_lease_idx", "target_activations_worker_lease_idx", "durable_objects_worker_lease_idx"],
      },
      ...
      "steal_expired_leases" => {
        ...
        allowed_indexes: ["workflows_expired_lease_idx", "durable_objects_expired_lease_idx"],
      },
      "record_step_started" => {
      ...
      "with_fence_existing" => {
        ...
        allow_post_filter_indexes: ["fences_pkey"],
      },
      "enqueue_outbox" => {
      ...
      "claim_outbox" => {
        ...
        allowed_indexes: ["outbox_claim_idx", "outbox_pkey"],
      },
      "ack_outbox" => {
