...
require_relative "../support/deterministic/scenario_sets"

class DurababbleDeterministicTest < DurababbleTestCase
  FUZZ_SCENARIOS = Durababble::Deterministic::ScenarioSets::FUZZ_SCENARIOS
  REGRESSION_SCENARIOS = Durababble::Deterministic::ScenarioSets::REGRESSION_SCENARIOS
  CONTRACT_SCENARIOS = Durababble::Deterministic::ScenarioSets::CONTRACT_SCENARIOS
  CLEAN_SCENARIOS = Durababble::Deterministic::ScenarioSets::CLEAN_SCENARIOS
  EXPLORATION_PROBE_SEEDS = Durababble::Deterministic::ScenarioSets::EXPLORATION_PROBE_SEEDS
  ...
  DEFAULT_FUZZ_SEEDS = Durababble::Deterministic::ScenarioSets::DEFAULT_FUZZ_SEEDS
