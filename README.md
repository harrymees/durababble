...
A durable object is an identity-addressed, serialized object. It has no workflow-step split: exposed commands are the durable command boundary, and exposed queries read current state.
