...
This is the web at its most powerful: a `<script>` tag that brings complete functionality. No npm/pnpm install, no build step, no framework dependency. Include a script, drop in a tag, and you have comments, analytics, video calling, or AI chat on your site.
