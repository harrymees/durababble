...
module Durababble
  class Store
    ...
    #: (workflow_id: String, name: String, ?command_id: Integer?, ?position: Integer?, ?worker_id: String?, ?event_index: Integer?) -> Object?
    def record_step_started(workflow_id:, name:, command_id: nil, position: nil, worker_id: nil, event_index: nil)
      raise NotImplementedError
    end

    #: (workflow_id: String, result: Object?, ?command_id: Integer?, ?position: Integer?, ?worker_id: String?, ?event_index: Integer?) -> Object?
    def record_step_completed(workflow_id:, result:, command_id: nil, position: nil, worker_id: nil, event_index: nil)
      raise NotImplementedError
    end

    #: (workflow_id: String, error: String, ?command_id: Integer?, ?position: Integer?, ?worker_id: String?, ?terminal: bool, ?error_class: String?, ?error_message: String?, ?event_index: Integer?) -> Object?
    ...
    #: (workflow_id: String, error: String, worker_id: String, run_at: Time, ?command_id: Integer?, ?position: Integer?, ?event_index: Integer?) -> Object?
    def record_step_failed_and_schedule_retry(workflow_id:, error:, worker_id:, run_at:, command_id: nil, position: nil, event_index: nil)
      raise NotImplementedError
    end

    #: (workflow_id: String, error: String, ?command_id: Integer?, ?position: Integer?, ?worker_id: String?, ?event_index: Integer?) -> Object?
    def record_step_canceled(workflow_id:, error:, command_id: nil, position: nil, worker_id: nil, event_index: nil)
      raise NotImplementedError
    end

    #: (workflow_id: String, name: String, wait_request: WaitRequest, ?command_id: Integer?, ?position: Integer?, ?suspend_workflow: bool, ?worker_id: String?, ?next_run_at: Object?, ?event_index: Integer?) -> Object?
