...
module Durababble
  module ChildWorkflowReuse
    class << self
      #: (Hash[String, Object?], origin_kind: String, child_workflow_name: String, child_workflow_id: String, input: Object?, worker_pool: String, cancellation_policy: String, ?parent_workflow_id: String?, ?parent_command_id: Integer?, ?parent_object_type: String?, ?parent_object_id: String?, ?parent_object_command_id: String?, ?colocate: bool) -> void
      def validate!(child, origin_kind:, child_workflow_name:, child_workflow_id:, input:, worker_pool:, cancellation_policy:, parent_workflow_id: nil, parent_command_id: nil, parent_object_type: nil, parent_object_id: nil, parent_object_command_id: nil, colocate: false)
