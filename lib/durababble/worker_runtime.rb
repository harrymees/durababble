...
module Durababble
  class WorkerRuntime
    ...
    #: (workflows: Object, worker_pool: String, ?objects: Object, ?store: Store?, ?database_url: String?, ?schema: String?, ?worker_id: String?, ?lease_seconds: Numeric, ?object_idle_ttl: Numeric?, ?poll_interval: Numeric, ?concurrency: Object, ?migrate: bool, ?rpc_host: String?, ?rpc_port: Integer?) -> void
    def initialize(
      workflows:,
      worker_pool:,
      objects: [],
